...
class Finetuner(BaseTuner):
    ...
    def group_text(self, tokenized_datasets, model_max_length):
        ...
        if data_args.block_size is None:
            ...
            if data_args.block_size > model_max_length:
                ...
                block_size = data_args.block_size
        pad_mask_token = data_args.pad_mask_token
        bd_size = data_args.bd_size
        # Main data processing function that will concatenate all texts from
        # our dataset and generate chunks of block_size.
        def group_texts(examples):
            mask_token_id = data_args.mask_id
    ...
    def tune(self,
        ...
        # Allow the entry script to inject extra callbacks (e.g. periodic
        # per-section eval) without modifying this file further.
        trainer_callbacks.extend(getattr(self, "_extra_callbacks", []))
